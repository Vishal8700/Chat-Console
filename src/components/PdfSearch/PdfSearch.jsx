...
//       const data = await response.json();
//       // Clean up the answer by removing unwanted symbols
...
//         backgroundColor: '#1e1e1e', // Match chat background
...
//       // Add system message about successful save
//       setChatMessages(prev => [
//         ...prev,
...
//             <button 
//               className="action-button save-pdf-button" 
